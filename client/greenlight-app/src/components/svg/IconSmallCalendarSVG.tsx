...
export const IconSmallCalendarSVG = () => {
  return (
    <View>
      <Svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <Path d="M17 3L17 7" stroke="white" stroke-width="1.2" stroke-linecap="round" />
        <Path d="M7 3L7 7" stroke="white" stroke-width="1.2" stroke-linecap="round" />
        <Path
